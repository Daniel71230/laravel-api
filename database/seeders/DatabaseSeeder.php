...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $genre->books()->create(['name' => 'Fathers and Sons', 'author_name' => 'Ivan Turgenev',
        'description' => 'Fathers and Sons, novel by Ivan Turgenev, published in 1862 as Ottsy i deti. Quite controversial at the time of its publication, Fathers and Sons concerns the inevitable conflict between generations and between the values of traditionalists and intellectuals.',
        'price' => 10.90]);

        $genre->books()->create(['name' => 'Demons', 'author_name' => 'Fyodor Dostoevsky',
        ...
        $genre->books()->create(['name' => 'Brave New World', 'author_name' => 'Aldous Huxley',
        ...
        $genre->books()->create(['name' => '11/22/63', 'author_name' => 'Stephen King',
        ...
        $genre = Genre::where('name', 'History')->first();
        $genre->books()->create(['name' => 'With Fire and Sword', 'author_name' => 'Henryk Sienkiewicz',
        'description' => "With Fire and Sword is a historical fiction novel, set in the 17th century in the Polish–Lithuanian Commonwealth during the Khmelnytsky Uprising. It gained enormous popularity in Poland, and by the turn of the 20th century had become one of the most popular Polish books ever.",
        'price' => 20]);
